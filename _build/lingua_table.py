...
LANGS.update({
    ...
    'glg': ('Galician', 'Indo-European > Romance', ['ES'], 2400000,
            'The rainy Atlantic corner in the north-west of the peninsula, far closer to the language over its southern border than to the state language.'),
    ...
    'fur': ('Friulian', 'Indo-European > Romance', ['IT'], 600000,
            'The north-eastern corner above the Adriatic where Romance meets Slavic and Germanic; a separate Rhaeto-Romance branch, not a dialect of the state language.'),
    'lld': ('Ladin', 'Indo-European > Romance', ['IT'], 30000,
            'Five Dolomite valleys, each with its own spelling of the same language, in a province whose other main language is Germanic.'),
    ...
    'lij': ('Ligurian', 'Indo-European > Romance', ['IT'], 500000,
            'The narrow strip of Riviera behind a great medieval port; its x is said like the s in "measure".'),
    ...
    'wln': ('Walloon', 'Indo-European > Romance', ['BE'], 600000,
            'The southern half of a small bilingual kingdom, where the Romance side is not the standard northern variety at all.'),
    ...
    'rup': ('Aromanian', 'Indo-European > Romance', ['MK', 'AL', 'GR'], 250000,
            'A Romance language stranded deep in the Balkans among Slavic and Hellenic speakers, and the closest living relative of the Danubian branch.'),
    'kea': ('Kabuverdianu', 'Creole > Portuguese-based', ['CV'], 900000,
            ...
            'A creole built on a Romance colonial language, in Western Africa.'),
    'pov': ('Guinea-Bissau Creole', 'Creole > Portuguese-based', ['GW', 'SN'], 1500000,
            ...
            'A Romance-lexified creole of Western Africa.'),
    'cri': ('Sãotomense', 'Creole > Portuguese-based', ['ST'], 70000,
            'A creole of two equatorial cocoa islands in the great bight of the west African coast.',
            'A Romance-lexified creole of Middle Africa.'),
    'pap': ('Papiamento', 'Creole > Iberian-based', ['AW', 'CW'], 300000,
            'A creole of three dry Caribbean islands off the northern shore of the southern continent, blending Iberian, Germanic and African, written with k and s where Castilian uses c.'),
    'mfe': ('Mauritian Creole', 'Creole > French-based', ['MU'], 1200000,
            'Almost everyone on a sugar island in the ocean east of Africa speaks it; its words are Romance, its grammar is not.',
            'A Romance-lexified creole of Eastern Africa.'),
    'crs': ('Seychellois Creole', 'Creole > French-based', ['SC'], 100000,
            'One of three official languages on a granite archipelago north of the sugar islands, and the only creole among them.',
            'A Romance-lexified creole of Eastern Africa, in the islands.'),
    'acf': ('Saint Lucian Creole', 'Creole > French-based', ['LC', 'DM'], 400000,
            'A creole spoken on two mountainous Windward islands whose official language is English.',
            'A Romance-lexified creole of the Caribbean.'),
})
...
LANGS.update({
    ...
    'nob': ('Norwegian (Bokmål)', 'Indo-European > Germanic', ['NO'], 5000000,
            'The majority written standard of a fjord kingdom that has two of them, and the one closer to the mainland standard over its southern border.'),
    ...
    'fao': ('Faroese', 'Indo-European > Germanic', ['FO'], 70000,
            'Eighteen windy North Atlantic islands, self-governing under a Nordic kingdom, whose spelling is far older than its pronunciation.'),
    ...
    'nds': ('Low Saxon', 'Indo-European > Germanic', ['DE', 'NL'], 5000000,
            'The old Hanseatic trade language of the northern plain, which never went through the consonant shift that turned water into Wasser.'),
    'ltz': ('Luxembourgish', 'Indo-European > Germanic', ['LU'], 400000,
            'The national language of a grand duchy that runs its government in two larger neighbouring languages as well.'),
...
LANGS.update({
    ...
    'bre': ('Breton', 'Indo-European > Celtic', ['FR'], 200000,
            'A Brittonic language carried back across the Channel to a granite peninsula, so its cousins are Brittonic and not Goidelic.'),
    'glv': ('Manx', 'Indo-European > Celtic', ['IM'], 2000,
            'A Goidelic language of one small island in the sea between two larger ones, declared extinct and then revived.'),
})
...
LANGS.update({
    ...
    'hsb': ('Upper Sorbian', 'Indo-European > Slavic', ['DE'], 20000,
            'A Slavic island surrounded by Germanic speakers in the east of a large federal republic, Catholic and still bilingually signposted.'),
...
LANGS.update({
    ...
    'rmn': ('Balkan Romani', 'Indo-European > Indo-Aryan', ['MK', 'RS', 'BG'], 700000,
            'An Indo-Aryan language spoken across the Balkans by people who left the north-west of the subcontinent a thousand years ago.'),
    'tly': ('Talysh', 'Indo-European > Iranian', ['AZ', 'IR'], 900000,
            'A language of the humid Caspian rice lowlands, split by a border between two states.',
            'An Indo-European language of the south-western Caspian shore.'),
    ...
    'oss': ('Ossetian', 'Indo-European > Iranian', ['GE', 'RU'], 500000,
            ...
            'An Indo-European language of the central Caucasus.'),
    'ady': ('Adyghe', 'Northwest Caucasian', ['RU'], 500000,
            'A Circassian language of the north-west Caucasus, with a huge consonant inventory and a large diaspora around the eastern Mediterranean.'),
