...

{
 ...
 "groups": [
   ...
   {"name": "NICKNAMED 'THE ___ ONE'", "tiles": ["SPECIAL", "NORMAL", "CHOSEN", "HAPPY"],
...

{
 ...
 "groups": [
   ...
   {"name": "LINES OF THE UEFA ANTHEM", "tiles": ["DIE MEISTER", "DIE BESTEN", "LES GRANDES", "THE CHAMPIONS"],
...

{
 ...
 "groups": [
   ...
   {"name": "DERBIES NAMED AFTER A RIVER OR A ROAD", "tiles": ["TYNE-WEAR", "EAST ANGLIAN", "M69", "SEVERNSIDE"],
...

{
 ...
 "diff": 5,
 "groups": [
   {"name": "HOSTING MATCHES AT THE 2026 WORLD CUP", "tiles": ["HOUSTON", "BOSTON", "TORONTO", "MONTERREY"],
   ...
   {"name": "FOOTBALL CLUBS THAT DO NOT EXIST", "tiles": ["AFC RICHMOND", "MELCHESTER", "HARCHESTER", "HOUNSLOW"],
